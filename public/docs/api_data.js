define({ "api": [
  ...
  },
  {
    ...
    "title": "Fetch all notices",
    "name": "FetchNotices",
    "group": "Notices",
    "description": "<p>Retrieve a list of notices based on the user's role and optional filters. Only active notices are returned.</p>",
    "header": {
      "fields": {
        "Header": [
          {
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "type",
            "description": "<p>(Admin only) Filter notices by type (&quot;student&quot;, &quot;teacher&quot;, or &quot;general&quot;).</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "count",
            "description": "<p>The total number of notices matching the criteria.</p>"
          },
          {
            "group": "Success 200",
            "type": "Object[]",
            "optional": false,
            "field": "notices",
            "description": "<p>List of notice objects.</p>"
          }
        ]
      }
    },
